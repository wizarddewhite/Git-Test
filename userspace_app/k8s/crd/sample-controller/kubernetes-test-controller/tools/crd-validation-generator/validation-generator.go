...
func main() {
	...
	dirname := flag.String("crdDir", "config/crd/", "path to directory with crds from where validation field will be parsed")
	outputdir := flag.String("outputDir", "cmd/controller/", "path to dir where go file will be generated")
